...
class Student :
    ...
    def __init__(self, root) :
        ...
        left_frame.place(x=10,y=10,width=690,height=590)
        ...
        cc_frame.place(x=5,y=30,width=690,height=120)
        ...
        student_info_frame.place(x=5, y=160, width=690, height=400)
        ...
        btn_frame = Frame(student_info_frame, bd=3, relief=RIDGE)
        btn_frame.place(x=0, y=300, width=700, height=100)  # Increased height to fit two rows
        ...
        clear_btn = Button(btn_frame, text="Clear", fg=button_fg, bg=button_bg,
                            command=self.delete_profile, width=10, activebackground="white", font=button_font)
        clear_btn.grid(row=0, column=2, padx=0, pady=0, sticky="ew")
        ...
        Right_frame.place(x=700,y=10,width=650,height=580)
