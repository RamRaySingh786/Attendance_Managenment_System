...
class Face_Recognition:
    ...
    def on_closing(self):
        """Handles the close event to ensure program exits gracefully."""
        self.attendance_marked = True  # Stop the loop in face_recog if it's running
        self.root.destroy()
    ...
    def face_recog(self):
        ...
        while True:
            ...
            if cv2.waitKey(1) == 13 or self.attendance_marked:
                ...
                # Timeout or manual exit
            if time.time() - start_time > 30:  # Exit after 30 seconds (adjust as needed)
                print("Exiting face recognition due to timeout.")
                break
